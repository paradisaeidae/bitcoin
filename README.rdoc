...
== Installation
 ...
 # OR
 git clone https://github.com/paradisaeidae/bitcoin-bsv.git; cd bitcoin-bsv; bundle install
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-bsv', git: 'https://github.com/paradisaeidae/bitcoin-bsv', branch: 'master', require: 'bitcoin'
