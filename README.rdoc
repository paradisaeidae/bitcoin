...
== Removed references to litecoin, dogecoin, namecoin. 
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-sv', git: 'https://github.com/paradisaeidae/bitcoin-sv', branch: 'master', require: 'bitcoin'
...
If you are curious or like to participate in development, drop by \#bitcoin-sv on irc.freenode.net!
