...
== Installation
 ...
 gem install bitcoin-sv
 # OR
 git clone https://github.com/paradisaeidae/bitcoin-sv.git; cd bitcoin-sv; bundle install
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-sv', git: 'https://github.com/paradisaeidae/bitcoin-sv', branch: 'master', require: 'bitcoin-sv'
