= bitcoin-bsv {<img src="https://api.travis-ci.org/lian/bitcoin-bsv.svg?branch=master" />}[http://travis-ci.org/lian/bitcoin-bsv] {<img src="http://inch-ci.org/github/lian/bitcoin-bsv.svg?branch=master" alt="Inline docs" />}[http://inch-ci.org/github/lian/bitcoin-bsv] {<img src="https://tip4commit.com/projects/108.svg" alt="tip for next commit" />}[https://tip4commit.com/github/lian/bitcoin-bsv]
...
== Installation
 ...
 gem install bitcoin-bsv
 # OR
 git clone https://github.com/lian/bitcoin-bsv.git; cd bitcoin-bsv; bundle install
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-bsv', git: 'https://github.com/lian/bitcoin-bsv', branch: 'master', require: 'bitcoin'
...
If you are curious or like to participate in development, drop by \#bitcoin-bsv on irc.freenode.net!
