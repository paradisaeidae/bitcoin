...
Integer =
 if Gem::Version.new(RUBY_VERSION) >= Gem::Version.new('2.4.0') then Integer
 else Fixnum end
...
def address_type(address)
 ...
 if segwit_decoded
  ...
  if witness_version == 0 && witness_program.bytesize == 20
   return :witness_v0_keyhash end
  if witness_version == 0 && witness_program.bytesize == 32
   return :witness_v0_scripthash end end
...
def hash160_to_p2sh_address(hex)
 encode_address hex, p2sh_version end
...
def encode_segwit_address(version, program_hex)
 ...
 return address.nil? ? nil : address end
 ...
 dns_seeds: [
  ...
  "dnsseed.test.webbtc.com",],
   ...
   checkpoints: {
     ...
     250000 => "0000000005910c146e4e8d71e8aa6617393738a9794b43cf113076dbaf08460b", } }) end